...
<%@ taglib prefix="s" uri="/struts-tags" %><%--sturts2 标签库--%>
...
<head>
    ...
    <ss:head locale="zh" parseContent="true"/>
    <!-- end: HEAD -->
    <!-- start: BODY -->
<body class="login">
<!-- start: LOGIN -->
<div class="row">
    <div class="main-login col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
        ...
        <!-- start: LOGIN BOX -->
        <div class="box-login">
            <form class="form-login" action="<%=path%>/Students/Students_add" method="post">
                <fieldset>
                    <legend>
                        添加一个用户
                    </legend>
                    ...
                    <div class="form-group">
                        <span class="input-icon">
                            ...
                            <input type="text" class="form-control" name="students.sname" placeholder="用户名" value="周杰伦">
                            <label class="block">
                                <label class="block">
                                    性别
                                </label>
                            ...
                            <ss:datetimepicker  value="%{'today'}"  name="students.birthday"></ss:datetimepicker>
                            <label class="block">
                                地址
                            </label>
                            <input type="text" class="form-control" name="students.address" value='北京'>
                        </span>
